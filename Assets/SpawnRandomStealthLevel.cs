...
public class SpawnRandomStealthLevel : MonoBehaviour
{
    ...
    void SpawnRandomObject(BoxCollider2D spawnArea)
    {
        ...
        GameObject instantiatedObject = Instantiate(randomObject, randomPosition, Quaternion.identity,Obstacles.transform);
